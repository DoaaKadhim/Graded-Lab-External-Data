...
// //   console.log(imgId)
// //   try {
// //     const isFavoriteResponse = await axios(`/favourites?image_id=${imgId}`);
// //     const isFavorite = isFavoriteResponse.data[0];
// //     console.log(isFavorite , isFavoriteResponse);

// //     if (isFavorite) {
// //       await axios.delete(`/favourites/${isFavorite.id}`);
// //     } else {
...
// //     }
// //   } catch (error) {
// //     console.log("An error occurred while processing the favourite action:", error);
// //   }
// // }
// export async function favourite(imgId) {
//   try {
...
//       headers: {
//         'x-api-key': 'live_JMdj3gAkMUtsP3c8U9AKTwDUW86Qfalm0Eyrfy7IAGctoAhp1UjvmMbrWMuinQKq'
//       }
//     });

//     if (isFavorite.data.length > 0) {
//       // If the image is already favorited, delete the favorite
//       const favoriteId = isFavorite.data[0].id;
//       await axios.delete(`/favourites/${favoriteId}`, {
//         headers: {
//           'x-api-key': 'live_JMdj3gAkMUtsP3c8U9AKTwDUW86Qfalm0Eyrfy7IAGctoAhp1UjvmMbrWMuinQKq'
//         }
//       });
//       console.log(`Image with ID ${imgId} has been removed from favorites.`);
//     } else {
//       // If the image is not yet favorited, add it to favorites
//       await axios.post("/favourites", {
//         image_id: imgId
//       }, {
//         headers: {
...
//         }
//       });
//       console.log(`Image with ID ${imgId} has been added to favorites.`);
//     }

//     // Redirect to the favorites list after updating the favorite status
//     window.location.href = "#favouritesSection";  // This will scroll to the favorites section
//   } catch (error) {
//     console.error(`Failed to toggle favorite status for image with ID ${imgId}:`, error);
//   }
// }
...
// }
// // Optionally, you can load the favorites when the page loads or when navigating to the section.
// window.addEventListener("DOMContentLoaded", () => {
//   if (window.location.hash === "#favouritesSection") {
//     getFavourites();
//   }
// });
...
//# sourceMappingURL=/Graded-Lab-External-Data.e31bb0bc.js.map